						...
						<ul class="navbar-nav">
								...
								<li class="nav-item dropdown">
								  ...
								  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
										<a class="nav-link cool" href="addstudentdetails.php">Student</a>
										<div class="dropdown-divider"></div>
										<a class="nav-link cool" href="addattendence.php">Attendance</a>
								  </div>
								</li>
								...
								<li class="nav-item dropdown">
								  <a class="nav-link dropdown-toggle cool" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									View <i class="fas fa-angle-down"></i>
								  </a>
								  <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
										<a class="nav-link cool" href="viewattendancelist.php">Attendance</a>
										<div class="dropdown-divider"></div>
										<a class="nav-link cool" href="viewinvigilationduty.php">Invigilation</a>
										<div class="dropdown-divider"></div>
										<a class="nav-link cool" href="viewstudent.php">Students</a>
								  </div>
								</li>
								<li class="nav-item ">
